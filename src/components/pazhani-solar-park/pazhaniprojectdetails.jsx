        ...
        <div className='row'>
          <div className='col-md-6'>
            <div className='img-con'>
              <img
                src='/img/home/Projects/pazhani-solar-park/down-img.jpg'
                alt=''
              />
            </div>
          </div>
          <div className='col-md-6 pt-5'>
            <div className='content-con' style={{ width: '100%' }}>
              <p className='text-white fs-16'>
                Pazhani Solar Park is located in Manjanayakkanpatty,
                Boduvarpatty and Chatrapatty Villages of Oddenchatram Taluk,
                Dindigul District near Pazhani, Tamilnadu , India. The solar
                farm is connected with 110/22 KV Sinthalampatty Substation
                through the 22 KV dedicated Double circuit transmission overhead
                line by using AL-59 Panther conductor under section 10(1) of
                Electricity act 2003. Bi Facial photovoltaic (PV) modules are
                installed ( with different capacities of 540 Wp, 550 Wp, 590Wp,
                600Wp and 710 Wp), creating a DC capacity of 41.9MWp
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='row justify-content-center text-center'>
          <div className='col-lg-12'>
            ...
            <p className='text-white'>
              Pazhani Solar Park utilises highly accurate forecasting to predict
          ...
          <div className='col-11 col-md-10 col-lg-9 col-xl-6'>
            <div className='battery-details '>
              ...
              <div className='battery-detail-row d-flex justify-content-between border-bottom py-2 row'>
                ...
                <span className=' text-orange1 col-7 px-0'>41.9MWp</span>
              </div>
              <div className='battery-detail-row d-flex justify-content-between border-bottom py-2 row'>
              ...
              <div className='battery-detail-row d-flex justify-content-between border-bottom py-2 row'>
                ...
                <span className='text-orange1 col-7 px-0'>
                  540 Wp, 550 Wp, 590Wp, 600Wp and 710 Wp Bi-facial, Trina
                  Solar, Jinko Solar and Goldi Solar
                </span>
              </div>
              <div className='battery-detail-row d-flex justify-content-between border-bottom py-2 row'>
