      ...
      <div className='container pt-10 pt-md-14'>
        <div className='row gx-2 gy-10 align-items-center'>
          <div className='col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start order-2 order-lg-0'>
            ...
            >
              Awards & <span className='underline-3 style-2 yellow'>Achievements</span>
            </h1>
            ...
            >
              <strong>Award for Innovation in Renewable Energy (2025):</strong><br/>
              Eternal Renewables received this award for Company of the Year –
              Solar EPC (Industrial) & Company of the Year – Innovation in
              Design & Engineering at the SolarQuarter Awards 2025
            </p>
            {/* <p
              className='lead fs-22 mb-7 text-white'
              style={slideInDownAnimate('900ms')}
