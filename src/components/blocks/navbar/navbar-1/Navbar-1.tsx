  ...
  const headerContent = (
    <Fragment>
      <div className="navbar-brand w-100">
        <NextLink href="/" title={<img alt="logo" src={`/img/sandbox-logo/header-logo.png`} srcSet={`/img/sandbox-logo/header-logo.png`} />} />
      </div>

      <div id="offcanvas-nav" data-bs-scroll="true" className="navbar-collapse offcanvas offcanvas-nav offcanvas-start bg-soft-primary">
        <div className="offcanvas-header d-lg-none">
        
          <img className="text-white mb-0" alt="logo" src={`/img/sandbox-logo/header-logo.png`} srcSet={`/img/sandbox-logo/header-logo.png`} style={{width:"70%"}}/>
