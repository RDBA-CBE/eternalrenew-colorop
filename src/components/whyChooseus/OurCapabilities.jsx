     ...
     const CapabilitiesList = [
      {
        ...
        title: 'Landowner Engagement & Agreements',
        // icon: 'uil-phone-volume',
        icon: '/img/why-choose-us/capabilities/1.png',
      ...
      },
      {
        ...
        title: 'Development',
         icon: '/img/why-choose-us/capabilities/2.png',
      ...
      },
      {
        ...
        title: 'Power Plant Design & Execution',
        icon: '/img/why-choose-us/capabilities/3.png',
      ...
      },
      {
        ...
        icon: 'uil-chart-line',
        title: 'Power Purchase Agreements (PPAs)',
        icon: '/img/why-choose-us/capabilities/4.png',
      ...
      },
      {
        ...
        icon: 'uil-phone-volume',
        title: 'Regulatory Authorizations',
        icon: '/img/why-choose-us/capabilities/5.png',
      ...
      },
      {
        ...
        icon: 'uil-shield-exclamation',
        title: 'Financing',
         icon: '/img/why-choose-us/capabilities/6.png',
      ...
      },
      {
        ...
        icon: 'uil-laptop-cloud',
        title: 'Construction Management',
        icon: '/img/why-choose-us/capabilities/7.png',
      ...
      },
      {
        ...
        icon: 'uil-chart-line',
        title: 'Asset Management',
        icon: '/img/why-choose-us/capabilities/8.png',
      ...
      <div className="row gx-md-8 gy-8 ">
        {CapabilitiesList.map((item) => (
          <CapabilityCard
            {...item}
            key={item.id}
            iconBoxClassNames="icon btn btn-block pe-none mb-6"
          />
        ))}
      </div>
        </div>
