          ...
          <div className='col-md-6 p-0'>
            <div className='content-con'>
              <p className='text-white '>
                ...
                Tempore, autem ducimus dolores quam aspernatur aliquam ab
                quisquam corporis necessitatibus quod maxime! Animi alias a
                tempora pariatur modi quaerat voluptas dicta!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='row justify-content-center text-center'>
          <div className='col-lg-12'>
            <p className='battery-quote text-white'>
              “ Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Tempore, autem ducimus dolores quam aspernatur aliquam ab quisquam
              corporis necessitatibus quod maxime! Animi alias a tempora
              pariatur modi quaerat voluptas dicta! Tempore, autem ducimus
              dolores quam aspernatur aliquam ab quisquam corporis
              necessitatibus quod maxime! Animi alias a tempora pariatur modi
              quaerat voluptas dicta!”
            </p>
          </div>
        </div>
