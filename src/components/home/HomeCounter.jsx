      ...
      ">
        ...
        <div className="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-2 text-green align-items-center">
          <div className="col-lg-4">
            ...
            <h2 className="mb-0 pe-xxl-10 text-white">We bring solutions to make life easier for our customers.</h2>
          </div>

          <div className="col-lg-8 mt-lg-2">
            <div className="row align-items-center counter-wrapper gy-6 text-center">
              {factList5.map(({ id,image, title, amount }) => (
                <Counter1 key={id} image={image} title={title} number={amount} titleColor="text-yellow" />
              ))}
            </div>
          </div>
        </div>
