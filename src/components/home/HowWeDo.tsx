...
export default function HowWeDo() {
    return (
        ...
        <section className="wrapper bg-green1  mt-0 hm-HowWeDo" style={{position:"relative",zIndex:"100"}}>
            <div className="container  h-auto" >
                <div className="row text-center h-auto" >
                    <div className="col-lg-12 mx-auto h-auto" style={{position:"relative",}}>
                        <h2 className="fs-15 text-uppercase mb-3 text-white how-we-do-subtitle">Turning Potential into Power</h2>
                        ...
                        <div className="row gx-lg-8 gx-xl-12 process-wrapper justify-content-center text-center mt-4">
                            {processList5.map(({ title, subtitle, Icon, color , icon}) => (
                                <div key={title} className="col-md-3 text-center custom-col-6">
                                    {/* {<Icon className={`icon-svg-md text-${color} mb-3`} />} */}
                                    <img src={icon} alt="icon" />
                                    <h4 className="mb-1 pt-2 text-white how-we-do-heading">{title}</h4>
                                    <p className="text-white fw-normal home-how-we-do">{subtitle}</p>
                                </div>
                            ))}
                        </div>
                    </div>
