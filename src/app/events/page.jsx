  ...
  return (
    <Fragment>
      ...
      <main className="content-wrapper">
        ...
        <BlogBanner title="Events"/>


        {/* ========== services section ========== */}
        {/* <MediaList /> */}

        <Blog title="Events" blogList1={blogList1}/>
